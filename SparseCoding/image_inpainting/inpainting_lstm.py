...
from models.LISTA_LSTM_model import LISTALSTM
...
def inpainting_lstm(missing_pixels, dicsize, n_nonzero_coefs, blksize, overlap, maxiter, grayimg):
    ...
    # training
    model = train_lstm(D, Y, maskvec, s, img_ori, blksize, overlap)
...
def train_lstm(D, Y, maskvec, s, img_ori, blksize, overlap):
    """
    Trianing LISTA-LSTM network.
    ...
    ListaNet = LISTALSTM(m, n, D, L, theta, max_iter=30)
