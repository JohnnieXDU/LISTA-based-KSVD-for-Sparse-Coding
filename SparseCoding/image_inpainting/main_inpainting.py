...
from image_inpainting import inpainting_omp, inpainting_ksvd, inpainting_ista, inpainting_lista
...
if __name__ == '__main__':
    ...
    if method == 'OMP':
        img_ori, masked_img, recovered_img = inpainting_omp.inpainting_omp(missing_pixels, dicsize,
                                                                           n_nonzero_coefs, blksize, overlap, maxiter, grayimg)
