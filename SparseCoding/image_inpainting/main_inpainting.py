...
from image_inpainting import inpainting_omp, inpainting_ksvd_omp, inpainting_ista, inpainting_lista, \
    inpainting_ksvd_lista, inpainting_lstm, inpainting_ksvd_ista, inpainting_ksvd_lstm
...
if __name__ == '__main__':
    ...
    if method == 'KSVD_ISTA':
        img_ori, masked_img, recovered_img = inpainting_ksvd_ista.inpainting_ksvd_ista(missing_pixels, dicsize, n_nonzero_coefs,
                                                                                 blksize, overlap, maxiter, grayimg)
    ...
    if method == 'KSVD_LISTA_LSTM':
        img_ori, masked_img, recovered_img = inpainting_ksvd_lstm.inpainting_ksvd_lstm(missing_pixels, dicsize, n_nonzero_coefs,
                                                                                 blksize, overlap, maxiter, grayimg)
